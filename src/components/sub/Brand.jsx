...
import ButtonPath from '../../hooks/useNavigate';
...
export default function BrandStory() {
	...
	return (
		<main title='BrandStory' ref={ref_el} className='main2'>

			<article className='ceoBox'>
				<div className='story'>
					<nav className='ceoTitle'>
						<SplitText style={{ margin: '25px 0px', fontFamily: 'Noto Serif KR', fontWeight: 'bold', fontSize: '2rem', color: `rgba(var(--keyRGB))` }}>
							향기의 권위자 Angelo의
						</SplitText>
						{isFirstTextRendered && (
